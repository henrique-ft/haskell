...
/* package stackproject-0.1.0.0 */
#define VERSION_stackproject "0.1.0.0"
#define MIN_VERSION_stackproject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "stackproject-0.1.0.0-pTX5qrLUdwLdTzGzZ4nZk"

#define CURRENT_PACKAGE_KEY "stackproject-0.1.0.0-pTX5qrLUdwLdTzGzZ4nZk"
